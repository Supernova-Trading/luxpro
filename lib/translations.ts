...
export const T: Record<Lang, Translation> = {
  ...
  fr: {
    ...
    qrCaption: "Scannez avec Revolut pour un pourboire à votre chauffeur",
  ...
  ar: {
    ...
    qrCaption: "امسح الرمز بتطبيق Revolut لإعطاء إكرامية لسائقك",
  ...
  ru: {
    ...
    qrCaption: "Отсканируйте в Revolut, чтобы дать чаевые водителю",
